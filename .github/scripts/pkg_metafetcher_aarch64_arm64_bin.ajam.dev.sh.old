...
# export SOURCE_BIN="https://bin.ajam.dev/aarch64_arm64_Linux" #ROOT Dir for bins

##Usage: 
# Actions: BIN="$BIN" REPO="$REPO" SOURCE_BIN="https://bin.ajam.dev/aarch64_arm64_Linux" bash "$GITHUB_WORKSPACE/main/.github/scripts/pkg_metafetcher_aarch64_arm64_bin.ajam.dev.sh"
# General: BIN="$BIN" REPO="$REPO" SOURCE_BIN="https://bin.ajam.dev/aarch64_arm64_Linux" bash <(curl -qfsSL "https://raw.githubusercontent.com/metis-os/hysp-pkgs/main/.github/scripts/pkg_metafetcher_aarch64_arm64_bin.ajam.dev.sh")
#List all available $BIN: curl -qfsSL "https://bin.ajam.dev/aarch64_arm64_Linux/METADATA.json" | jq -r '.[].Name' | sort -u

#List NAME:SIZE format
# curl -qfsSL "https://bin.ajam.dev/aarch64_arm64_Linux/METADATA.json" | jq -r 'map("\(.Name):\(.Size)") | .[]' | sort -u
